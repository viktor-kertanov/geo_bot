...
def anketa_name(update, context):
    ...
    if len(user_name.split()) < 2:
        update.message.reply_text('Введите пожалуйста имя и фамили ю в формате "[Имя]⎵[Фамилия]"')
        return "name"
    else:
...
def anketa_fallback(update, context):
     update.message.reply_text("Были введены данные, которые мы не можем обработать.\nПопробуйте ещё раз ввести данные в правильном формате. ")