...
def guess_number_game(user_number: int) -> str:
    ...
    if guess == user_number:
        ...
        message = f'Ты выиграл, потому что ты загадал {user_number}, а я загадал {guess} 🎉 🎊 ❤️'
    else:
        message = f'К сожалению, ты проиграл: я загадал {guess}, а ты {user_number} но я по-прежнему бездушный бот. А у тебя душа есть... 💔'
